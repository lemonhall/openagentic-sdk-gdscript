# vr-offices-bind-device-code-ui

## Purpose

Define the VR Offices desk “bind device code” operator UI copy and layout requirements to ensure the flow is readable and consistent for English-first UI.
