...
const _NpcLoader := preload("res://vr_offices/core/npcs/VrOfficesNpcLoader.gd")
...
func _init(
	...
	_autosave = autosave
	_loader = _NpcLoader.new(_owner, _npc_scene, _npc_root, _profiles, _move_ctrl, _is_headless, _npc_spawn_y, _spawn_extent)

func set_spawn_params(npc_spawn_y: float, spawn_extent: Vector2) -> void:
	_npc_spawn_y = npc_spawn_y
	_spawn_extent = spawn_extent
	if _loader != null: _loader.call("set_spawn_params", _npc_spawn_y, _spawn_extent)
...
func set_culture(code: String) -> void:
	...
	if _loader != null:
		_loader.call("update_all_npc_names")
...
func add_npc() -> Node:
	...
	if _loader != null:
		_loader.call("apply_profile_to_npc", npc, npc_id, profile_index)
...
func find_npc_by_id(npc_id: String) -> Node:
	if _loader == null:
		return null
	return _loader.call("find_npc_by_id", npc_id) as Node
...
func load_from_state_dict(st: Dictionary) -> void:
	...
	if _loader != null:
		_npc_counter = int(_loader.call("load_npcs_from_state_list", list, _npc_counter))
	_apply_ui_state()
